...
class MainActivity : AppCompatActivity() {
    ...
    fun closeNesting() {
        ...
        // إصلاح: تصفير جلسة التسليم بين العارض و Nesting عند الخروج من الشاشة،
        // بحيث أي فتح جديد لـ Nesting (مثلاً من Slicer باختيار "مقاسات مخصصة")
        // يبدأ نظيفاً تماماً بدون أي ملف DXF قديم متبقٍّ من زيارة سابقة.
